      ...
      <div className="min-h-[50vh] mt-5">
        ...
        <div className="w-full flex items-center justify-center mt-4">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center justify-center gap-2 w-[90%] p-2 rounded-full bg-gradient-to-tr from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-500 transition-all duration-75 ease-in-out text-gray-50 text-lg my-2 hover:shadow-lg"
          >
